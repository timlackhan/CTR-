local _M = {
	...
	features_for_predict[model_attrs["adx"]] = args["adx"] or 0
    end,

    gen_impct = function (features_for_predict,args,model_attrs)
	features_for_predict[model_attrs["impct"]] = args["impct"] or 0
    end,
	...
	features_for_predict[model_attrs["creative_id"]] = args["creative_id"]
    end,
	...
	features_for_predict[model_attrs["devicetype"]] = args["devicetype"]
    end,
